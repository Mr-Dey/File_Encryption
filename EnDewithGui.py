...
def changeTheme():
    ...
    if theme=="Light":
        ...
        theme_button.configure(text="Switch Lightmode")
    else:
        ctk.set_appearance_mode("light")
        theme_button.configure(text="Switch Darkmode")
...
root.iconbitmap("E:\other\py\EncryptDecrypt\main2.ico")
...
theme_button=ctk.CTkRadioButton(f1,text="Switch Darkmode",command=changeTheme,font=defaulFont)
